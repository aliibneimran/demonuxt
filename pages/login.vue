    ...
    >
      <div class="relative sm:max-w-sm w-full">
        ...
        >
          <label
            for=""
            class="block mt-2 text-lg text-gray-700 text-center font-semibold"
          >
            Login
          </label>
          <form method="#" action="#" class="mt-10">
            <div>
              <input
                ...
                class="mt-1 px-4 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0"
              />
            </div>
            ...
            <div class="mt-7">
              <div class="flex justify-center items-center">
                <label class="mr-2">Have not account?</label>
                <a
                  href="#"
